package it.mathanalisys.hubcore.bungee.utils;
...
public class BungeeServerUtils implements PluginMessageListener {
    ...
    public BungeeServerUtils(){
        Bukkit.getServer().getMessenger().registerIncomingPluginChannel(HubCore.get(), "BungeeCord", this);
        Bukkit.getServer().getMessenger().registerOutgoingPluginChannel(HubCore.get(), "BungeeCord");
        loadSelector();
    }
    ...
    public void loadSelector(){
        ...
        }.runTaskTimerAsynchronously(HubCore.get(), 2L, 2L);
    }
    ...
    public static void sendToServer(Player player, String server){
        ...
        player.sendPluginMessage(HubCore.get(), "BungeeCord", byteArrayOutputStream.toByteArray());
    }
