package it.killergamerpls.hubcore.utils.netherboard.bukkit.util;
...
public class NMS {
    ...
    static {
        ...
        try {
            ...
            if (VERSION.is1_18() || VERSION.is1_19()) {
            ...
            switch (VERSION.getMajor()) {
                case "1.7" -> packetScore = packetScoreClass.getConstructor(scoreClass, int.class);
